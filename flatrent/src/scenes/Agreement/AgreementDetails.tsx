...
class AgreementDetails extends Component<RouteComponentProps<IAgreementDetailsRouteProps>, IAgreementDetailsState> {
    ...
    public render() {
        ...
        const invoiceList =
            statusId === AgreementStatuses.Accepted || statusId === AgreementStatuses.Ended ? (
                <InvoiceList className={Styles.list} title="Sąskaitos" agreement={agreement} />
            ) : (
                <></>
            );
        ...
        const incidentList =
            statusId === AgreementStatuses.Accepted || statusId === AgreementStatuses.Ended ? (
                <IncidentList className={Styles.list} title="Incidentai" agreement={agreement} />
            ) : (
                <></>
            );
        ...
        return (
            <>
                ...
                <FlexRow className={Styles.listRow}>
                    {invoiceList}
                    {incidentList}
                </FlexRow>
                <FlexColumn className={Styles.content}>
...
const UsersLoader = () => (
    <FlexRow className={Styles.loaderRow}>
        <ContentLoader
            className={Styles.usersLoader}
            height={200}
            width={210}
            speed={2}
            primaryColor="#f3f3f3"
        ...
        >
            ...
            <rect x="60" y="45" rx="3" ry="3" width="120" height="8" />
            <rect x="70" y="70" rx="3" ry="3" width="110" height="8" />

            <rect x="40" y="95" rx="3" ry="3" width="140" height="10" />
            <rect x="110" y="120" rx="3" ry="3" width="70" height="8" />
            <rect x="100" y="145" rx="3" ry="3" width="80" height="10" />
            <rect x="0" y="170" rx="3" ry="3" width="180" height="8" />
...
const CommentsLoader = () => (
    <ContentLoader
        className={Styles.commentsLoader}
        height={140}
        width={600}
        speed={2}
        primaryColor="#f3f3f3"
