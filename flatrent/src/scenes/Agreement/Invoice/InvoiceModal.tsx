...
import { agreementUrl, joined, stopPropogation } from "../../../utilities/Utilities";
...
class InvoiceModal extends Component<
    RouteComponentProps<{ id: string; invoiceId: string }> & IInvoiceModalProps,
    IInvoiceModalState
> {
    ...
    public render() {
        ...
        if (this.props.invoices.length > 0 && invoice === undefined) {
            this.exitModal();
            return <></>;
        }
