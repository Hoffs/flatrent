...
namespace FlatRent.Migrations
{
    ...
    [Migration("20190526125115_RemoteTenantFromAgreement")]
    partial class RemoteTenantFromAgreement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlatRent.Entities.Incident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlatRent.Entities.Invoice", b =>
                {
                    ...
                    b.Property<DateTime>("InvoicedPeriodFrom");

                    b.Property<DateTime>("InvoicedPeriodTo");
            ...
            modelBuilder.Entity("FlatRent.Entities.Attachment", b =>
                {
                    ...
                    b.HasOne("FlatRent.Entities.Incident", "Incident")
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("FlatRent.Entities.Incident", b =>
                {
                    ...
                    b.HasOne("FlatRent.Entities.User", "Author")
                        .WithMany("RegisteredIncidents")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FlatRent.Entities.Conversation", "Conversation")
                        .WithOne("Incident")
                        .HasForeignKey("FlatRent.Entities.Incident", "ConversationId")
                        .OnDelete(DeleteBehavior.Restrict);
